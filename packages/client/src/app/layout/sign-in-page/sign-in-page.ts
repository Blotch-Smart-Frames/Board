  ...
  template: `
    <div class="flex h-screen items-center justify-center gap-4 p-6">
      <div hlmCard class="mx-4 flex w-full max-w-md flex-col gap-4 p-8 text-center">
        ...
        <p class="text-muted-foreground">Organize your tasks with a beautiful, collaborative board.</p>
        ...
        <div class="flex flex-col items-center gap-4">
          ...
          <p class="text-muted-foreground mt-4 block text-xs">
            ...
            <a href="/terms.html" target="_blank" rel="noopener" class="underline">Terms of Service</a>
            and
            <a href="/privacy.html" target="_blank" rel="noopener" class="underline">Privacy Policy</a>.
          </p>
        </div>
      </div>
    </div>
